...
void hydraulics_channel_gvf::calcul_HAF(){
    ...
    if(ui->comboBox_methode_calcul->currentIndex()==0 && ui->radioButton_NR->isChecked()){
        methode_NR();
    }
    if(ui->comboBox_methode_calcul->currentIndex()==0 && ui->radioButton_RK4->isChecked()){
        methode_RK4();
    }
    if(ui->comboBox_methode_calcul->currentIndex()==0 && ui->radioButton_KM->isChecked()){
        methode_KM();
    }
    if(ui->comboBox_methode_calcul->currentIndex()==0 && ui->radioButton_Trap->isChecked()){
        methode_Trap();
    }
...
void hydraulics_channel_gvf::afficher_information(double yc,double yn,
    ...
    ui->lineEdit_yc->setValue(yc);
    ui->lineEdit_yn->setValue(yn);

    if (profiletype=="M1"||profiletype=="M2"||profiletype=="M3") {
        ui->label_typeCourbeRemous->setPixmap(QPixmap(QString::fromUtf8(":/icons/mildslope.png")));
        ui->label_exempleCourbeRemous->setPixmap(QPixmap(QString::fromUtf8(":/icons/M1M2M3.png")));
    }
    if (profiletype=="C1"||profiletype=="C3") {
        ui->label_typeCourbeRemous->setPixmap(QPixmap(QString::fromUtf8(":/icons/criticalslope.png")));
        ui->label_exempleCourbeRemous->setPixmap(QPixmap(QString::fromUtf8(":/icons/C1C3.png")));
    }
    if (profiletype=="S1"||profiletype=="S2"||profiletype=="S3") {
        ui->label_typeCourbeRemous->setPixmap(QPixmap(QString::fromUtf8(":/icons/steepslope.png")));
        ui->label_exempleCourbeRemous->setPixmap(QPixmap(QString::fromUtf8(":/icons/S1S2S3.png")));
    }
    if (profiletype=="H2"||profiletype=="H3") {
        ui->label_typeCourbeRemous->setPixmap(QPixmap(QString::fromUtf8(":/icons/horizontalslope.png")));
        ui->label_exempleCourbeRemous->setPixmap(QPixmap(QString::fromUtf8(":/icons/H1H2H3.png")));
    }
    if (profiletype=="A2"||profiletype=="A3") {
        ui->label_typeCourbeRemous->setPixmap(QPixmap(QString::fromUtf8(":/icons/adverseslope.png")));
        ui->label_exempleCourbeRemous->setPixmap(QPixmap(QString::fromUtf8(":/icons/A1A2A3.png")));
    }

    QString resultatsfr1;
    QString resultatsfr2;
...
void hydraulics_channel_gvf::Sfmoy_NR_HAF(){
    if (ui->radioButton_NR->isChecked()){
...
void hydraulics_channel_gvf::Affichage_ycyn_HAF(){
    ...
    ui->lineEdit_yn->setValue(yn);
    ui->checkBox_useYi->setChecked(false);
    ui->textBrowser_resultats->clear();
